...
func init() {
	os.Setenv("APP_ID", "a32036b2d4f84f09be1a15c0b593bb6b")
	os.Setenv("APP_CERTIFICATE", "ef7820406ede44569c5bdc0b0ec3145e")
...
func getRtmToken(c *gin.Context) {
	...
	channelName, _, _, _, _, _ := parseRtcParams(c)
	...
	rtmToken, tokenErr := rtmtokenbuilder2.BuildToken(appID, appCertificate, uidStr, expireTimestamp, channelName)
...
func getBothTokens(c *gin.Context) {
	...
	// generate rtmToken
	rtmToken, rtmTokenErr := rtmtokenbuilder2.BuildToken(appID, appCertificate, uidStr, expireTimestamp, channelName)
